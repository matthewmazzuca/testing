...
describe Property do
  ...
  describe ".filter_by_title" do
    before(:each) do
      @property1 = FactoryGirl.create :property, name: "Gleb's House"
      @property2 = FactoryGirl.create :property, name: "Joey's House"
      @property3 = FactoryGirl.create :property, name: "Matthew's House"
      @property4 = FactoryGirl.create :property, name: "Matthew's Condo"
    end
    
# Other Specs that can be set are below
